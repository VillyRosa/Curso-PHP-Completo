                ...
                if ($sql->execute([$nome,$email,$senha_cript,$recupera_senha,$token,$codigo_confirmacao,$status,$data_cadastro])) {
                    ...
                    if ($modo == "producao") {
                        ...
                        try { 
                            ...
                            $mail->Subject = 'Confirma seu cadastro!'; // TITULO DO EMAIL
                            $mail->Body    = '<h1>Por favor confirme seu e-mail abaixo:</h1><br><br><a style="background:green; color:white; padding:20px; text-decoration: none; border-radius: 5px;" href="https://seusistema.com.br/confirmacao.php?cod_corfirm='.$codigo_confirmacao.'">Confirmar E-mail</a>';

                            $mail->send();
                            header('location: obrigado.php');

                        } catch (Exception $e) {
                            echo "Ouve um problema ao enviar o e-mail de confirmação!";
                        }
